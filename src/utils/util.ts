...
export const getGenderFromText = (genderText: string): Number => {
  if (genderText.toLowerCase() == config.gender.genderMaleText.toLowerCase()) {
    return config.gender.genderMale;
  } else if (genderText.toLowerCase() == config.gender.genderFemaleText.toLowerCase()) {
    return config.gender.genderFemale;
  } else {
    return config.gender.genderNa;
  }
};
